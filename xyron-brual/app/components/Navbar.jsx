            ...
            <div className="md:flex items-center justify-between bg-[#010409] py-4 md:px-10 px-7 text-gray-50">
                ...
                <div>
                    <ul className={`md:flex md:items-center ${!open ? 'hidden' : 'mt-2'}`}>
                        {Links.map((link) => (
                            <li key={link.name} className="text-gray-400 cursor-pointer rounded-md px-3 py-2 hover:bg-[#191b22] hover:font-medium hover:text-gray-50 hover:border-b-2 border-gray-50">
